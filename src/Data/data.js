export const data = [
    {
        id: 1,
        itemName: 'Echeveria "Atlantis"',
        category: 'succulent',
        price: 7.99,
        description: 'Echeveria "Atlantis": Blue-green rosette with light pink leaf margins and a powdery coating of farina. There is a slight wave to leaves and the rosette produces a pink-orange flower on a tall, arching bloom stalk.Echeveria need bright sunlight to maintain their colors and compact rosette form. They will not survive a hard frost, but if there is a risk of freezing temperatures they can be brought indoors to grow on a sunny window sill or under a grow light.Like most succulents, they need great drainage and infrequent water to prevent rot. Pick containers with drainage holes and use well-draining cactus and succulent soil with 50% to 70% mineral grit such as coarse sand, pumice, or perlite. Water deeply enough for water to run out the drainage hole, then wait for the soil to fully dry before watering.',
    ...
    {
        id: 2,
        itemName: 'Echeveria "Dusty Rose"',
        category: 'succulent',
        price: 6.99,
        description: 'Echeveria "Dusty Rose": A medium-sized rosette with stunning, variable coloration. Its wide, spatulate leaves are hues of pink and violet, deepening in color when grown in bright sunlight. It has a thick coating of natural wax that both allows it to tolerate full sun and gives it a soft, pastel appearance. Though slow to offset, "Dusty Rose" does send up a tall bloom stalk from which hang coral, bell-shaped flowers.Echeveria need bright sunlight to maintain their colors and compact rosette form. They will not survive a hard frost, but if there is a risk of freezing temperatures they can be brought indoors to grow on a sunny window sill or under a grow light.Like most succulents, they need great drainage and infrequent water to prevent rot. Pick containers with drainage holes and use well-draining cactus and succulent soil with 50% to 70% mineral grit such as coarse sand, pumice, or perlite. Water deeply enough for water to run out the drainage hole, then wait for the soil to fully dry before watering again.',
    ...
    {
        id: 3,
        itemName: 'Echeveria "White Lady"',
        category: 'succulent',
        price: 4.99,
        description: 'Tight rosettes of slighted elongated, pointed leaves feature a soothing sea foam green hue, with an added pastel element courtesy of a thick coating of powdery farina. Indeed, it is this layer that gives Echeveria ‘White Lady’ its name, as the most thickly coated leaves will appear almost white in color! The singular, soft spines at the tips of each leaf will blush red when exposed to bright sunlight, and the upper edges of the leaves are a lighter tone than the primary green hue – adding creamy yellow contrast to the plant, especially when viewed from above.Capable of thriving either indoors or out, provided that it is not exposed to frosty weather, ‘White Lady’ will put on its best coloration in bright sunlight – which has the added benefit of preventing the rosettes from stretching, or etiolating. Beyond this, the most critical component of this variety’s care is to avoid excess moisture. To accomplish this, be sure to pot ‘White Lady’ in a porous soil mixture within a well-draining container, situated in a location with ample airflow. Water thoroughly but infrequently, making sure never to pour water into the rosettes themselves, instead watering the soil surface directly.',
    ...
    },
    {
        ...
        category: 'agave',
        price: 16.99,
        description: 'Agave "Kissho Kan", a stunning and rare miniature variety, also known as "White-Centered Thunder Queen" or ‘Variegated Dwarf Butterfly,’ will reach a mature size of only 4 inches across. The leaves, which often sport natural growth scarring near the tips, are a rich blue-green with cream variegation, in a pattern resembling paints that have been gently swirled together. What it lacks in size this succulent more than makes up for in visual drama, and it is sure to make a great focal point in any succulent collection.Despite its rarity, ‘Ohi Raijin Shiro Nakafu’ is not a difficult plant to care for. Bright sunlight, porous soil, and a well-draining pot are the key requirements for success with this variety, as is thorough but infrequent watering. Further, it is important to protect this variety from frost during the winter months, as it is not cold hardy below freezing.',
    ...
    },
    {
        ...
        category: 'agave',
        price: 7.99,
        description: 'Agave "Snow Glow": An elegant variegate with jade green leaves and creamy yellow margins. This plant, like many other Agave species, has sharp spines at the tips of each leaf and is very fibrous. Plant well away from walkways.Agave need plenty of full, outdoor sunlight and great drainage to thrive. They do well in gritty, mineral soils and pots with drainage holes. Over time you\'ll see new offsets or "pups" sprout up around the base of the mother plant.Agave grow slowly in the spring and summer and can tolerate high heat and extended drought. This variety is frost hardy to about 15F if kept dry through the winter. Protect from heavy rains and standing water to prevent rot.',
    ...
    },
    {
        ...
        category: 'agave',
        price: 7.99,
        description: 'Agave "Blue Glow": A popular cultivar with a phenomenal appearance. Its firm, pointed foliage is blue-green with a natural, chalky coating. It has contrasting leaf margins of red and yellow that appear to glow when backlit. It is a slow-grower and works well in landscaping and containers. "Blue Glow" is thought to be a cross of A. ocahui x A. attenuata. It can reach 2.5\' tall and 3.0\' wide at maturity.',
        images: ["https://www.seekpng.com/png/full/67-678784_blue-glow-agave-agave-blue-glow-png.png"
    ...
    {
        id: 10,
        itemName: 'Echeveria "Allegra"',
        category: 'succulent',
        price: 5.99,
        description: 'Easy to propagate and safe around pets and children, ‘Allegra’ is as simple to care for as it is beautiful. Bright sunlight is the key to maintaining its distinct coloration and compact growth form, while thorough but infrequent watering will help protect against ills such as rot. Ample airflow, a porous soil mixture, and a readily draining pot will go the rest of the way towards ensuring a thriving, healthy succulent!',
        images: ["https://cdn.shopify.com/s/files/1/1124/9666/products/echeveria-allegra-top_1080x.jpg?v=1497411776",
        "https://i.imgur.com/IZCXiGk.jpg",],
        showMore: false,

    },
    {
        id: 11,
        itemName: 'Echeveria "Blue Jay"',
        category: 'succulent',
        price: 11.99,
        description: 'Drawing its name from its native habitat of the Cape of South Africa, Aloe ferox "Cape Aloe" grows profusely along arid hillsides, which gives an indicator of its hardy nature! This succulent forms a dense rosette that emerges atop a single stem, giving the mature plant a unique, tree-like appearance reaching up to several feet in height. The thick blue-green leaves feature teeth around the margins, accented by spikes of bright reddish orange flowers during the growing season. When ‘sun stressed,’ the leaves and teeth often flush a warm, rosy color, creating a stunning contrast that looks especially showy when arranged alongside light green or deep blue succulent varieties.Like all Aloe, this relatively slow grower prefers bright sun conditions, and is extremely drought hardy once established. As a result, it is vital to house this plant within a very porous soil mixture and a well-draining pot, ensuring adequate airflow around the leaves and soil surface. Water thoroughly but infrequently, in accordance with the ‘soak and dry’ method – and note that if the leaves feel rigid and thus full of water, ‘Cape Aloe’ is not in need of a drink',
        images: ["https://cdn.shopify.com/s/files/1/1124/9666/products/echeveria-blue-jay_1080x.jpg?v=1531272224",
    ...
    {
        id: 12,
        itemName: '"Castilloniae"',
        category: 'aloe',
        price: 24.99,
        description: 'This Madagascar native is remarkable for its unusual, densely low-growing nature. Reaching only 6 inches in height, Aloe castilloniae can eventually grow on to form a dense mat of foliage up to several feet in width! The kelly green leaves are dotted with maroon ridges along both their margins and their upper surface, creating an especially eye-catching appearance.While this variety, like all Aloe plants, is known to be quite forgiving of neglect, it is possible to over-care for your succulent, especially in the form of overwatering. To avoid this fate, be sure to follow the ‘soak and dry’ method of watering, and ensure that your plant is housed in porous soil within a well-draining pot. Furthermore, plenty of bright sunlight, in combination with sufficient airflow around the leaves and soil surface, will ensure healthy, robust growth and will maintain the rich coloration of Aloe castilloniae.',
